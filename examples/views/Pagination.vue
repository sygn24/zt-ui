<template>
    <div class="page">
        ...
        <div class="row">
            <h3>小型分页</h3>
            <zt-pagination :total="60" :current-page.sync="currentPage6" small></zt-pagination>
        </div>
        <div class="row">
            <h3>带有背景色</h3>
        ...
        <div class="row">
            <h3>可设置每页显示数量,不传page-sizes，默认[10,20,30,40,50]</h3>
            <zt-pagination :total="1200" :current-page.sync="currentPage7" border background show-total show-sizes></zt-pagination>
        </div>
        <div class="row">
            <h3>
...
export default {
    ...
    methods: {
        pageChange(page) {
            this.$msg('第' + this.currentPage5 + '页')
            console.log(page)
        },
